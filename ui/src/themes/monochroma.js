...
const musicListActions = {
  ...
  '@global': {
    ...
    'button:first-child:not(:only-child)': {
      ...
      background: monoWhite['500'],
      color: '#000',
      borderRadius: 500,
      border: 0,
      '&:hover': {
        transform: 'scale(2.1)',
        backgroundColor: `${monoWhite['300']} !important`,
        border: 0,
      },
    },
    'button:only-child': {
  ...
  overrides: {
    ...
    MuiButton: {
      root: {
        ...
        borderRadius: 500,
        '&:hover': {
          background: `${monoWhite['900']} !important`,
        },
      },
      textSecondary: {
        border: '1px solid #b3b3b3',
    ...
    NDAlbumGridView: {
      ...
      albumPlayButton: {
        backgroundColor: monoWhite['500'],
        borderRadius: '50%',
        boxShadow: '0 8px 8px rgb(0 0 0 / 30%)',
        padding: '0.35rem',
        transition: 'padding .3s ease',
        '&:hover': {
          background: `${monoWhite['300']} !important`,
          padding: '0.45rem',
        },
      },
    },
